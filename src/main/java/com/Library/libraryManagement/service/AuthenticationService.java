...
import com.Library.libraryManagement.entitie.Role;
import com.Library.libraryManagement.entitie.Token;
import com.Library.libraryManagement.entitie.TokenType;
...
public class AuthenticationService
{
    ...
    {
        boolean  isFound = repository.findByEmail(request.getEmail()).isPresent();
        if(isFound) throw new IllegalArgumentException("Email already in use");
